...
@pytest.mark.asyncio
async def test_save_auth_store_writes_0o600_with_0o700_parent(tmp_path, monkeypatch):
    ...
    try:
        ...
        auth_path = await auth_mod._save_auth_store(auth_store)
    finally:
        os.umask(old_umask)
...
@pytest.mark.asyncio
async def test_save_auth_store_uses_os_open_with_0o600_mode(tmp_path, monkeypatch):
