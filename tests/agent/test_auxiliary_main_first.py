...
class TestResolveAutoMainFirst:
    ...
    @pytest.mark.asyncio
    async def test_resolve_provider_auto_returns_runtime_model_not_stale_config_default(self):
    ...
    @pytest.mark.asyncio
    async def test_runtime_base_url_passed_for_named_api_key_provider(self):
        ...
        with patch(
            ...
            await _resolve_auto(main_runtime={
                "provider": "xiaomi",
                "model": "mimo-v2.5-pro",
...
class TestResolveVisionMainFirst:
    ...
    @pytest.mark.asyncio
    async def test_copilot_vision_sets_vision_header(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_text_copilot_does_not_set_vision_header(self, monkeypatch):
        ...
        with patch(
            ...
            client, model = await resolve_provider_client("copilot", "gpt-5-mini")
