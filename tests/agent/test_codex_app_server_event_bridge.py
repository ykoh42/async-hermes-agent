...
class TestBridgeWiredInRuntime:
    ...
    @pytest.mark.asyncio
    async def test_session_constructor_receives_on_event(self, monkeypatch):
        ...
        class FakeSession:
            ...
            async def run_turn(self, user_input, **_):
        ...
        async def sync_external_memory_for_turn(**_):
            return None
        ...
        agent = SimpleNamespace(
            ...
            _sync_external_memory_for_turn=sync_external_memory_for_turn,
        ...
        await codex_runtime.run_codex_app_server_turn(
            agent,
            user_message="hi",
