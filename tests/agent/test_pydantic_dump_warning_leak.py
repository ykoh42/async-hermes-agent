...
def test_relay_llm_jsonable_no_warning_leak():
    _jsonable = pytest.importorskip("agent.relay_llm")._jsonable
...
def test_relay_tools_jsonable_no_warning_leak():
    _jsonable = pytest.importorskip("agent.relay_tools")._jsonable
...
def test_duck_typed_model_dump_fallback():
    ...
    rl_jsonable = pytest.importorskip("agent.relay_llm")._jsonable
    rt_jsonable = pytest.importorskip("agent.relay_tools")._jsonable
    from agent.anthropic_adapter import _to_plain_data
