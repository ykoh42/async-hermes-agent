...
class TestNoMoreRowsRetry:
    async def test_transient_interface_error_is_retried_to_success(self, db):
    ...
    async def test_unrelated_interface_error_propagates_immediately(self, db):
