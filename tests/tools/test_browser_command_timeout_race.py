...
class TestGetCommandTimeoutRace:
    ...
    async def test_max_call_site_pattern_never_raises(self):
        ...
        timeout = max(await self.bt._safe_command_timeout(), 60)
        assert timeout == 60
