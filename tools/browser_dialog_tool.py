...
async def _browser_dialog_check() -> bool:
    ...
    try:
        ...
        return False
    return await _browser_cdp_check()


async def _handle_browser_dialog(args: Dict[str, Any], **context: Any) -> str:
    """Adapt registry arguments to the public dialog function."""
    return await browser_dialog(
...
registry.register(
    ...
    handler=_handle_browser_dialog,
