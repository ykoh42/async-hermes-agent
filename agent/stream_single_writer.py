...
# ContextVar instances must be module-scoped: Context objects keep strong
# references to their variables. Values are immutable snapshots keyed by weak
# agent references, so copied task contexts isolate claims without extending an
# AIAgent's lifetime.
_STREAM_WRITER_TASK_TOKENS = contextvars.ContextVar(
    "hermes_stream_writer_task_tokens",
    default=None,
)
