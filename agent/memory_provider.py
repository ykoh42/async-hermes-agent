...
class MemoryProvider(ABC):
    ...
    async def initialize(self, session_id: str, **kwargs) -> None:
        ...
        establish connections, and warm provider state.
    ...
    async def prefetch(self, query: str, *, session_id: str = "") -> str:
        ...
        should be fast and use native async transport for remote recall.
    ...
    async def sync_turn(
        ...
        *,
        ...
        Called after each turn using the provider's native async transport.
