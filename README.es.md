...
en la etiqueta upstream `v2026.8.18` (versión del paquete Python `0.20.4`).
...
La versión tiene cuatro segmentos numéricos: `0.20.4.1` indica la versión
Python upstream `0.20.4` y la revisión `1` de esta distribución asíncrona. Las
