...
async def _fetch_commandcode_models(
    ...
    try:
        ...
        resp = await open_credentialed_url(req, timeout=timeout)
        with resp:
...
class CommandCodeProfile(ProviderProfile):
    ...
    async def fetch_models(
        ...
        *,
        ...
        return await _fetch_commandcode_models(api_key=api_key, timeout=timeout)
...
class CommandCodeAnthropicProfile(ProviderProfile):
    ...
    async def fetch_models(
        ...
        *,
        ...
        """
        all_models = await _fetch_commandcode_models(api_key=api_key, timeout=timeout)
